...
<header class="site-header" id="siteHeader">
    <div class="container header-inner">
        ...
        <nav class="main-nav" id="mainNav">
            ...
            <a href="bureau.php" class="<?= $currentPage === 'bureau.php' ? 'active' : '' ?>">المكتب</a>
            <a href="membres.php" class="<?= $currentPage === 'membres.php' ? 'active' : '' ?>">أعضاؤنا</a>
            <a href="contact.php" class="<?= $currentPage === 'contact.php' ? 'active' : '' ?>">اتصل بنا</a>
            <a href="join_us.php" class="nav-cta-outline">انضم إلينا</a>
            <a href="don.php" class="nav-cta">تبرع الآن</a>
        </nav>
    </div>
</header>
