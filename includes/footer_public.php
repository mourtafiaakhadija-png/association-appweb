...
<footer class="site-footer">
    <div class="container footer-welcome">
        <p>🌙 مرحبا بكم في فضاء جمعية الجيل المبدع، حيث يلتقي العطاء بالأمل</p>
    </div>
    <div class="container footer-inner">
        ...
        <div class="footer-col">
            ...
            <a href="projets.php">مشاريعنا</a>
            <a href="don.php">تبرع الآن</a>
            <a href="join_us.php">انضم إلينا كمتطوع</a>
        </div>
